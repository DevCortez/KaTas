...
potato.Wait(2)
potato.Button(Controller.down, duration=22)
potato.Roll()
potato.Wait(22)
potato.Roll()
potato.Wait(18)
...
potato.Wait(4)
potato.Button(Controller.down, duration=0)
potato.Roll()
potato.Wait(12)
#door slash
potato.Button(Controller.X, duration=0)
potato.Wait(10)
potato.Button(Controller.down, duration=2)
potato.Wait(1)
potato.Roll()
potato.Wait(15)
#dropping down slash
...
potato.Button(Controller.X, duration=0)
potato.Wait(1)
potato.Button(Controller.down, duration=38)
...
potato.Button(Controller.X, duration=0)
potato.Wait(1)
potato.Button(Controller.right, duration=10)
potato.Wait(5)
potato.Roll()
potato.Wait(14)
...
potato.Button(Controller.X, duration=0)
potato.Wait(6)
potato.Button(Controller.down, duration=66)
potato.Roll()
potato.Wait(22)
potato.Button(Controller.down, duration=1)
potato.Roll()
potato.Wait(22)
potato.MoveLeftStick(180)
potato.Button(Controller.X, duration=0)
